...
def calcular_totales_fac(datos_factura):
    subtotal_0 = subtotal_15 = subtotal_no_sujeto = subtotal_exento = ice = iva_15 = irbpnr = 0.0
    ...
    if importe_total == 0.00:
        importe_total = subtotal_sin_impuestos + iva_15 + irbpnr + ice + propina - descuento
