...
from sri_xml_bot.librerias.rides.constantes import *
from sri_xml_bot.librerias.diccionarios import ambiente, tipo_emision, nombres_comprobantes_excel
...
from sri_xml_bot.librerias.rides.funciones_auxiliares import dividir_y_centrar_texto, es_gran_contribuyente, es_agente_retencion
...
def calcular_totales_nc(datos_factura):
    subtotal_0 = subtotal_5 = subtotal_12 = subtotal_14 = subtotal_15 = subtotal_no_sujeto = subtotal_exento = ice = iva_5 = iva_12 = iva_14 = iva_15 = irbpnr = 0.0
